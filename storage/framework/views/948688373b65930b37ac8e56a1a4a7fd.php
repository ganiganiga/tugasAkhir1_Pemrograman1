...
from-gray-600 to-gray-800 text-white shadow-xl z-50">
    ...
    <div class="p-6">
        ...
        <nav class="space-y-2">
            <a href="/admin/dashboard"
               ...
               <?php echo e(request()->is('admin/dashboard') ? 'bg-gray-700' : ''); ?>">
            ...
            <a href="/admin/products"
               class="flex items-center px-4 py-3 rounded-lg hover:bg-gray-700
               <?php echo e(request()->is('admin/products*') ? 'bg-gray-700' : ''); ?>">
            ...
            <a href="/admin/orders"
               class="flex items-center px-4 py-3 rounded-lg hover:bg-gray-700
               <?php echo e(request()->is('admin/orders*') ? 'bg-gray-700' : ''); ?>">
    ...
    <div class="absolute bottom-0 w-64 p-6">
        ...
        <p class="text-center font-medium mb-4"><?php echo e(session('admin_name')); ?></p>
...
<div style="padding-left:256px; min-height:100vh; display:flex; flex-direction:column;">
    ...
    <header class="bg-white shadow px-6 py-4">
        <div class="flex justify-between items-center">
            ...
            <span class="text-gray-600"><?php echo e(now()->format('l, d M Y')); ?></span>
        </div>
    </header>
...
<?php /**PATH C:\Users\algha\Downloads\FEBEOptik\FEBEOptik\resources\views/admin/layout.blade.php ENDPATH**/ ?>